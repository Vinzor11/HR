...
class SuperAdminSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'view-faculty-employees', 'module' => 'Employees', 'label' => 'View Faculty Employees', 'description' => 'Can view employees in their faculty regardless of role'],
            ['name' => 'view-department-employees', 'module' => 'Employees', 'label' => 'View Department Employees', 'description' => 'Can view employees in their department/office regardless of role'],
