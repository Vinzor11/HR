export const TrainingsTableConfig = {
    columns: [
        ...
        { label: 'Faculties', key: 'allowed_faculties', className: 'p-4', type: 'multi-values', displayKey: 'name' },
        { label: 'Departments', key: 'allowed_departments', className: 'p-4', type: 'multi-values', displayKey: 'faculty_name' },
